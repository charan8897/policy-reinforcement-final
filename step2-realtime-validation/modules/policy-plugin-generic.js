    ...
    class SuggestionPopup {
      ...
      `;
        ...
        show(data) {
            ...
            progress.className = 'policy-progress';
    ...
    class PolicyPlugin {
        ...
        async validateField(fieldName, fieldValue, previousContext = null) {
            ...
            try {
                ...
                console.log(`[TIMING-FRONTEND] Validation started for ${fieldName}=${fieldValue}`);
                ...
                console.log(`[TIMING-FRONTEND] Network request completed: ${responseTime - requestTime}ms`);
                ...
                console.log(`[TIMING-FRONTEND] JSON parse completed: ${parseTime - responseTime}ms`);
                console.log('[TIMING-FRONTEND] Backend response:', result);

                // Display the validation result as returned by backend (status can be 'valid', 'warning', or 'error')
                ...
                console.log(`[TIMING-FRONTEND] ✓ Total time: ${totalTime}ms (Request: ${responseTime - requestTime}ms, Parse: ${parseTime - responseTime}ms)`);

                // Show validation result (including error status - which is a valid validation result)
                this.popup.show({
                ...
                const totalTime = Date.now() - startTime;
                console.error(`[TIMING-FRONTEND] ✗ Error after ${totalTime}ms:`, error);
                console.error('[TIMING-FRONTEND] Error details:', error.message);
